...
{
    public partial class FavouriteStadiumPage : PhoneApplicationPage
    {
        #region Fields
        ...
        public FavouriteStadiumPage()
        {
            ...
            StadiumList.SelectionChanged += StadiumListOnSelectionChanged;

            SearchBox.DoSearch += SearchBox_DoSearch;

            SearchBoxFeedback.CancelSearch += SearchBoxResults_CancelSearch;

            PageHeaderControl.PageTitle = AppResources.FavouriteStadiumPage;
        ...
        private void StadiumListOnSelectionChanged(object sender, LongListStadiumsControl.StadiumSelectionChangedEventArgs e)
        {
            App.AppConstants.FavStadium = e.Stadium;
        ...
        {
            var list = App.FreeEntryViewModel.Stadiums(sortDirection, searchTerm);
            StadiumList.StadiumLongList.ItemsSource = (System.Collections.IList)list;
        }
